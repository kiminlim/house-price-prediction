...
spreadLevelPlot(log_m1) #. Suggested power transformation 값은 일정하지 않은 오차의 분산을 안정화시키기 위해 필요한 power transformation 값을 제시해준다.
...
# > Global Stat  > 3.277e-05ㄹ 가정 만족하지 않음.. ㅜㅜㅜ
...
# 현재까지  log2개 일때&변수2일ㄸ개 가 가장 잘 설명.
